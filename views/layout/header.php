...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark ">
        <a class="navbar-brand text-white" href="../">
            <img src="<?= base_url ?>assets/img/camiseta.png" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy">
            Tienda Online
        </a>
        ...
        <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-white ico" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <?php else : ?>
                            <a class="dropdown-item" href="<?= base_url ?>pedido/mispedidos">Mis Pedidos</a>
                ...
                <li class="nav-item text-white  d-flex align-items-center">
                    <a class="nav-link text-white  ico" href="<?= base_url ?>carrito/">
                        <i class="fas fa-shopping-cart"></i> (<?= $stats['count'] ?>)
                    </a>
                </li>
            </ul>
